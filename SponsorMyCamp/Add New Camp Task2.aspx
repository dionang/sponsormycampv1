<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="Add New Camp Task2.aspx.cs" Inherits="SponsorMyCamp.Add_New_Camp_Task2" %>
...
<body>
    ...
    <div class="content">
           ...
           <div style="margin-left:15px">
            ...
            <div class="col-sm-8">
            <asp:TextBox style="width:330px" class="form-control" ID="TextBox1" runat="server" required="true" Text="Sports Camp (2020) "></asp:TextBox></div></div>
            <br />
             <div class="row">
            <div class="col-sm-4">
