<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="firstTask2.aspx.cs" Inherits="SponsorMyCamp.firstTask2" %>
       ...
       <br />
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="inner-addon left-addon">
                <i class="glyphicon glyphicon-user"></i>
                <asp:TextBox class="form-control" ID="tbName" runat="server" CssClass="box" Text="Moses" required="true"></asp:TextBox>
            </div>
            </div>
        ...
        <div class="row">
            ...
            <asp:TextBox class="form-control" ID="tbEmail" runat="server" CssClass="box" required="true" Text="moses.2010@smu.edu.sg"></asp:TextBox>
            </div>
            </div>
        ...
        <div class="row">
            ...
            <asp:TextBox class="form-control" ID="tbMobile" runat="server" CssClass="box" required="true" Text="87654390"></asp:TextBox>
            </div>
            </div>
        ...
        <br />
         <div class="row">
            ...
            <div class="col-md-6">
                <div class="inner-addon left-addon">
                <i class="glyphicon glyphicon-user"></i>
                <asp:TextBox class="form-control" ID="tbUserName" runat="server" CssClass="box" required="true" Text="Moses88"></asp:TextBox>
            </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="inner-addon left-addon">
                <i class="glyphicon glyphicon-lock"></i>
            <asp:TextBox class="form-control" ID="tbPassword" type="password" runat="server" CssClass="box" required="true" Text="mosesishappy"></asp:TextBox>
            </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="inner-addon left-addon">
                <i class="glyphicon glyphicon-lock"></i>
             <asp:TextBox class="form-control" ID="tbCPassword" type="password" runat="server" CssClass="box" required="true" Text="mosesishappy"></asp:TextBox>
            </div>
            </div>
