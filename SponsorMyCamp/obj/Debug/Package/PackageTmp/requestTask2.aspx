<%@ Page Title="" Language="C#" MasterPageFile="~/HeaderTAsk2.Master" AutoEventWireup="true" CodeBehind="requestTask2.aspx.cs" Inherits="SponsorMyCamp.requestTask2" %>
...
<div class="row content">
    ...
    <div class="col-md-9" style="height:410px">
        ...
        <a href="inboxTask2.aspx" class="confirm" id="sendBtn">Send</a>
        </div>
    </div>
</div>
