<%@ Page Title="" Language="C#" MasterPageFile="~/HeaderTask.Master" AutoEventWireup="true" CodeBehind="contractTask.aspx.cs" Inherits="SponsorMyCamp.contractTask" %>
...
<div class="row content">
    ...
    <div class="requestContent" style="width:780px;height:350px;padding:4px;">
       ...
       <br />
        ...
        <a href="inboxTask.aspx" class="confirm" id="sendBtn" style=" margin-left:690px;">Send</a>
        </div>
    </div>
    </div>
</div>
...
<script>
    $(".confirm").confirm({
        title: 'Confirm!',
        text: "Are you sure you want to send the contract?",
