<%@ Page Title="" Language="C#" MasterPageFile="~/HeaderTAsk2.Master" AutoEventWireup="true" CodeBehind="inboxTask2.aspx.cs" Inherits="SponsorMyCamp.Inboxtask2" %>
     ...
     <div class="col-md-1 mailList">
        ...
        <div style="height:410px;width:180px;background-color:#E3ECF0;">
            <asp:RadioButtonList ID="RadioButtonList5" runat="server" CssClass="list">
                <asp:ListItem Selected="True">Nunsongyee</asp:ListItem>
                <asp:ListItem >KFC</asp:ListItem>
            </asp:RadioButtonList>
        </div> 
    </div>
    <div class="col-md-6 mailList" >
    <div style="width:760px; height:410px;">
    <p style=" OVERFLOW:auto; width:780px; height:410px;margin-left:-20px;border:1px solid #C0C0C0;padding:30px">
        <b>Nunsongyee</b> has cancelled the sponsorship due to shortage of inventory on event date.
...
<asp:Panel ID="sentRequest" runat="server">
    ...
    <div class="col-md-6 mailList">
        ...
        <u><b>Subject: Collaboration Opportunity with Singapore Management University Freshmen Orientation Camp</b></u>
        <br /><br />
        Dear Sir/Mdm,
        <br />
        The <u><b>Singapore Management University</b></u> will be holding its annual<u><b>Freshman Orientation Camp</b></u> from <u><b>15 Aug 2018 to 18 Aug 2018</b></u>. With an expected turnout of <u><b>300</b></u> people, the camp aims to <u><b>warmly welcome incoming freshmen to the university</b></u>.
        <br />
        I would like to invite you to be part of this yearly event by collaborating with us as a valued sponsor. SMU is in the heart of the city and is recognised internationally for its innovative research and multidisciplinary curriculum. With the entire SMU school population of more than 7,000, I am convinced that our camp can provide your company with a unique platform to enhance your brand awareness. Some examples include having <u><b>your company’s logo on our website and our social media platforms</u></b>. Partnering with us is possible through many different avenues, and we also look forward to exploring alternative options with you too.
        <br />
    ...
    <div class="col-md-6 mailList">
       ...
       For the upcoming Freshmen Orientation Camp happening on <u><b>15/08/2018 – 18/08/2018</b></u>, we are pleased to be collaborating with <u><b>KFC</b></u> to receive the following sponsored items in the stated quantity:
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Sponsorship</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>ProducQuantity</b>
        <br />
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Food – 2pc chicken set meal</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>350</b>
        <br /><br />
